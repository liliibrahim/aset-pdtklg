...
<tr>
    <th class="px-3 py-2 text-left align-top">Bil</th>
    <th class="px-3 py-2 text-left align-top">Tarikh Aduan</th>
    <th class="px-3 py-2 text-left align-top">Pengadu</th>
    <th class="px-3 py-2 text-left align-top">Maklumat Aset</th>
    <th class="px-3 py-2 text-left align-top">Status</th>
    <th class="px-3 py-2 text-left align-top">Tindakan ICT</th>
</tr>
</thead>
...
<tr class="border-t">
    ...
    <td class="px-3 py-2 align-top">
        ...
        @elseif($aduan->status === 'dalam_tindakan')
    ...
    <td class="px-3 py-2 align-top">
        <form method="POST"
            ...
            <select name="tindakan_ict" class="border rounded px-2 py-1 text-sm">
